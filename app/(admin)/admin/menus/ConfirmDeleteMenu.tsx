'use client'
// app/(admin)/admin/menus/ConfirmDeleteMenu.tsx
...
export default function ConfirmDeleteMenu({
  ...
  const popover = open ? (
    <div
      className="z-[9999] w-56 rounded-xl shadow-2xl p-3"
      style={{
        position: 'fixed',
        top: pos.top,
        left: pos.left,
    ...
    >
      ...
      <p className="text-[11px] mb-1.5" style={{ color: 'var(--text-muted)' }}>
        This will also delete all its sub-menus.
      </p>
      <p className="text-[11px] mb-3 truncate font-medium" style={{ color: 'var(--text-secondary)' }}>
        &ldquo;{name}&rdquo;
      </p>
